...
public sealed class ValidateAccountDirectoryRequestAttribute : ActionFilterAttribute
{
    public override void OnActionExecuting(ActionExecutingContext context)
    {
        var request = context.ActionArguments.Values.OfType<AccountDirectoryRequest>().SingleOrDefault();
        if (request is null)
        {
            return;
        }
