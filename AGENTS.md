...
Use `NODE_AUTH_TOKEN` for private package installation. Container orchestration is defined by the root `compose.yaml` in the `l2-infra` integration repository.
